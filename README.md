...
- Configure VM options for the run configuration by adding the following to your VM options: --module-path /path/to/javafx-sdk-26/lib --add-modules javafx.controls,javafx.media making sure to replace /path/to/javafx-sdk-26/lib with your actual JavaFX lib directory.
